...
package com.khs.test.jdbc.datasource;
...
public class DSInitializer implements InitializingBean, DisposableBean {

	private static final Log logger = LogFactory.getLog(DSInitializer.class);
